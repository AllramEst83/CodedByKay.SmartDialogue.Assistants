...
namespace CodedByKay.SmartDialogue.Assistants.Services
{
    /// <summary>
    ...
    internal class ChatHistoryService : IChatHistoryService
    {
        ...
        private readonly SmartDialogueOptions _options;
        ...
        public ChatHistoryService(SmartDialogueOptions options)
        {
            _options = options;
        }
