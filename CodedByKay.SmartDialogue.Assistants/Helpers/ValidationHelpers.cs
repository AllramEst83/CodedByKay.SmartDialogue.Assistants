...
namespace CodedByKay.SmartDialogue.Assistants.Helpers
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Validates the provided <see cref="SmartDialogueAssistantsOptions"/> to ensure they are correctly configured.
        /// </summary>
        /// <param name="options">The options to validate.</param>
        /// <exception cref="ArgumentException">Thrown if any configuration option is invalid.</exception>
        internal static void ValidateOptions(SmartDialogueOptions options)
        {
